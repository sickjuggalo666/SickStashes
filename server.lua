...
QBCore.Functions.CreateUseableItem("water", function(source, item)
    ...
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('SickStashes:secretstash', source, Player.PlayerData.citizenid, item.info, item.slot)
    end
end)
...
QBCore.Functions.CreateCallback("SickStashes:checkVehicleOwner", function(source, cb, plate, owner)
